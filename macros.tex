...
\newcommand{\AB}[1]{\mathbf{AB}\if\relax\detokenize{#1}\relax\else(#1)\fi}
\newcommand{\AC}[1]{\mathbf{AC}\if\relax\detokenize{#1}\relax\else(#1)\fi}
...
\newcommand{\ABC}{\textbf{AB-Cond}}
\newcommand{\SBC}{\textbf{SB-Cond}}
...
% One edge vollowed by s split into two edges
% #1: first node
% #2: first edge label
% #3: middle node
% #4: second edge label
