\begin{tikzpicture}[on grid,node distance=.8 and .7]
  ...
  \path[morphism]
    (01) edge[morphism,->] (11)
	(111) edge[morphism,bend left=30,->] (011)
	(112) edge[morphism,bend left=30,->] (012)
	;
	
  \path[morphism]
    (21) edge[morphism,|->] (11)
	(111) edge[morphism,bend right=30,->] (211)
	(112) edge[morphism,bend right=30,->] (212)
	;
	
  \path
    (32) edge[morphism,bend left=20,->] (21)
	(212) edge[morphism,bend right=30,->] (321)
	;
\end{tikzpicture}
