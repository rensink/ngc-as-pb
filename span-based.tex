...
\end{align*}
\begin{itemize}
\item $c'\pequiv c''$ because the identity morphism $\id_{c'}$ is a direct complete forward-shift morphism from $c'$ to $c''$ due to $(s^c_{o(i)},\dF v(\cB(s^c_{o(i)})))\in \ccP_\id$ for all $1\leq i\leq w$ (see \lcite{BF});
