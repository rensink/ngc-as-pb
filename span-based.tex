...
\todo{AC:  Add section about correspondence between span-based conditions in Graph and FOL? Could be concise, given that most definitions are in Section~\ref{sec:FOL}}
