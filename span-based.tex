...
\begin{enumerate}[topsep=\smallskipamount]
\item We only need to show this for $\rF v x$ (where $x;v=\id_B$). Let $s=\spanof u d$, $\rF v x=s_1=\spanof{u_1}{d_1}$ and $\dF v(s)=s_2=\spanof{u_2}{d_2}$. Now $k=x'$ as in \cite{sb-shifters} shows $(s_1,s_2)\in \cP_\id$ according to \eqcite{pattern shift}.
