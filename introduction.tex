...
Note that differently from the $\exists$-fragment, the structures representing the $\exists \neg \exists$-fragment are no longer graphs, but diagrams (``stars'') in \cat{Graph}, the category of graphs; and satisfaction does not require just the existence of a matching morphism from $L$, but also the non-existence of certain other morphisms.
...
In \scite{ab-morphisms} we present the original definition of morphism among such conditions, which come in two variants giving rise to two categories of conditions. Soundness of morphisms w.r.t.~entailment is ensured by the existence of functors to the category of conditions with the entailment preorder.
...
In \scite{conclusion} we summarize the contributions of the paper, discuss some related work and hint at future developments. Full proofs of most of the statements and a few auxiliary results are collected in the appendix.
