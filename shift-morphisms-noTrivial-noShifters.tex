...
\todo {AC: since we introduced shift of ab-conditions along a morphism and precomposition of conditions with a morphism, we don't need a separate definition of root shifters. Therefore the beginning of this section can be greatly simplified.}
