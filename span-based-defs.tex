...
\begin{enumerate}
\item Let $f: R \to Q$ be an arrow in $\cat{C}$. The \emph{shift of $c$ along $f$} is the sb-condition $\shift{c}{f} = (Q,(\spanof {u_1;f} {d_1},{c_1})\cdots(\spanof {u_w;f} {d_w},{c_w}))$.\todo{AC: drawing necessary} Note that unlike ab-condition, shifting along an arrow affects only the top level arrows. 
