...
\begin{proof}~
\begin{itemize}
\item \textit{If:} To show \eqcite{shifters are functors}, consider $\cS(a;t)=s;a;t=\cS(a);t$. To show \excite{forward condition}, note that $\cS(v)=s;v=\id_B$.
...
\item \textof{If:} To show \eqcite{shifters are functors}, consider $\cS(a;t)=v;a;t=\cS(a);t$. To show \excite{backward condition}, note that $\cS(\id_B)=v;\id_B=v$.
