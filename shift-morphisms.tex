...
\iffull
\begin{proposition}
For every $R$, $\AC R$ gives rise to categories $\ABC^\forw(R)$ with forward-shift morphisms and $\ABC^\back(R)$ with backward-shift morphisms.\todo{AR: Add to span-based, and add functiorality. AC: This is already done, right?}
\end{proposition}
%
\fi
